...
to setupCaterpillar
  create-caterpillars number_caterpillar[
...
to setupChry
  create-chrysalides number_chry[
    set shape "circle"
...
to setupBut
  create-butterflies number_butterfly[
    set shape "butterfly"
    set size 2
    setxy random-xcor random-ycor
    set color red
